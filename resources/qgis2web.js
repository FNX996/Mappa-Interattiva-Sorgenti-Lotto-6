...
map.getView().fit([776103.150624, 5733731.399779, 802654.323317, 5746149.226454], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Mappa BIM Sorgenti - InGeoLab s.r.l</h2>';
        return titleElement;
    })(),
